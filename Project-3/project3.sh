...
#Create a Mongo DB cluster using DBaaS mLab

#Create an environment variable .env and add connection string of mongodb
touch .env
vi .env

mongodb+srv://nathaniel:experiment626@cluster0.8e5mh.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
...
cd /home/ubuntu/Todo && npm run dev
